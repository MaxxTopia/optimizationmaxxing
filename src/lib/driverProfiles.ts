...
export const DRIVER_PROFILE_CATALOG: DriverProfileRecord[] = [
  {
    ...
    settingsCount: 4,
    sha256: '0b88c93840a30f45df9f0de5ca25e9d5900c2d66badd2c8b8d81862b0797afa2',
  ...
  },
  {
    ...
    reviewedOn: '2026-09-21',
    settingsCount: 7,
    sha256: '15b68d2cc7a6e8ba9a82b4325e6e7f0b7c4e3fe7bf760afbaad5e17bc6a9a7f6',
    objective: 'An experimental image/latency A/B profile that stays within normal driver controls.',
    ...
    warnings: ['Experimental and visual-quality dependent.', 'It does not remove foliage, clouds, terrain, or alter visibility.'],
  },
  {
    id: 'valorant',
    kind: 'nvidia-nip',
    ...
    reviewedOn: '2026-09-21',
    settingsCount: 6,
    sha256: 'd82b2180a480368632e28afaf465f623c13e350f8bc469a1580efab6a070e8d3',
  ...
  },
  {
    ...
    reviewedOn: '2026-09-21',
    settingsCount: 6,
    sha256: 'b57e0812c3573fc677dd4cb2a8adc3ea4019a41804fc81ac2e6283a7514eedee',
    objective: 'A versioned driver-profile candidate for controlled testing.',
    rollback: ['Export the existing profile before import.', 'Restore the export and Apply changes if the capture regresses.', 'Reopen NVPI to confirm the restored values.'],
  ...
  },
  {
    ...
    reviewedOn: '2026-09-21',
    settingsCount: 6,
    sha256: '00327a2f5008be502e1337a2a3b919543d123631bb1e015507514029916d48a8',
    objective: 'A versioned driver-profile candidate for controlled testing.',
    rollback: ['Export the existing profile before import.', 'Restore the export and Apply changes if the capture regresses.', 'Reopen NVPI to confirm the restored values.'],
  ...
  },
  {
    ...
    reviewedOn: '2026-09-21',
    settingsCount: 12,
    sha256: 'b551a605e89be47b44fde38e5caecaeb117b91654e09951c019c5afbc76dc8c6',
    objective: 'A versioned driver-profile candidate for controlled testing.',
    rollback: ['Export the existing profile before import.', 'Restore the export and Apply changes if the capture regresses.', 'Reopen NVPI to confirm the restored values.'],

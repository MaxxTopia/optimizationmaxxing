...
export const GRIND_LAST_REVIEWED = '2026-09-25'
...
export const GRIND_ENTRIES: GrindEntry[] = [
  ...
  },
  {
    ...
    rig: {
      dpi: '800',
      sensitivity: '6.3% / 6.3% · target/scope 45%',
      pollingHz: 1000,
  ...
  },
  {
    ...
    rig: {
      dpi: '800',
      sensitivity: '8.7% / 6.3% · target 60% / scope 35%',
      pollingHz: 1000,
  ...
  },
  {
    ...
    rig: {
      dpi: '800',
      sensitivity: '6.4% / 6.4% · target/scope 45%',
      pollingHz: 1000,

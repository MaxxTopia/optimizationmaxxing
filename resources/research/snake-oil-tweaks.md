...
- **bcdedit clock flags (useplatformclock / useplatformtick / disabledynamictick): revert to default.** Microsoft documents these as debugging-only; on Windows 11 disabledynamictick is tied to mouse-input desync and added latency. As of v0.2.6 we gate disabledynamictick to Win10 and removed it from our presets.
